...
estimate is higher if we only select few of the `nchoose(nrow(data), choose)`
...
# d = 5, choose = 10 -> choose(nrow(mtcars), 3)
seq <- rep(seq(10, 480, by = 100), each = 10) * 10
score <- lapply(seq, approx_leave_d_out, data = mtcars, d = 3)
